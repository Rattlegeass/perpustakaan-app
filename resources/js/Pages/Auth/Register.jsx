    ...
    return (
        ...
        >
            ...
            <div className="w-full md:w-1/2 h-full flex flex-col z-20 bg-[#F4F7FA] overflow-y-auto hide-scroll">
                ...
                {/* 1. BLOK ATAS: Tombol Beranda (Dibuat static agar tidak menabrak form) */}
                ...
                {/* 2. BLOK TENGAH: Form Register (Akan mengisi sisa ruang secara terpusat) */}
                <div className="flex-1 flex items-center justify-center p-6 md:p-8">
                    {/* Padding dan margin dikurangi agar form tidak terlalu panjang */}
                    <div className="w-full max-w-md bg-white/80 backdrop-blur-md rounded-[20px] shadow-[0_8px_30px_rgba(0,0,0,0.06)] border border-white/50 p-6 sm:p-8 transition-all duration-300 hover:shadow-[0_15px_40px_rgba(0,0,0,0.08)] animate-slide-up-fade relative z-10">
                        <div className="mb-6 text-center sm:text-left">
                            <h2 className="text-3xl font-heading font-bold text-[#10375C]">Daftar Akun</h2>
                            <p className="text-gray-500 mt-1.5 text-sm font-light">Lengkapi formulir di bawah untuk bergabung.</p>
                        </div>
                        ...
                        <form onSubmit={submit} className="space-y-4">
                            ...
                            <div className="relative group">
                                <InputLabel 
                                    htmlFor="name" 
                                    value="Nama Lengkap" 
                                    className="text-gray-600 font-medium mb-1 block transition-transform duration-300 origin-left transform group-focus-within:-translate-y-1 group-focus-within:text-[#10375C]" 
                                />
                                <TextInput
                                    id="name"
                                    name="name"
            ...
            {/* ======================================================== */}
            {/* BAGIAN KANAN: VISUAL & ANIMASI PARALLAX */}
            {/* ======================================================== */}
            <div className="relative hidden md:flex md:w-1/2 h-full bg-animated-gradient items-center justify-center overflow-hidden z-10">
                ...
                <div className="absolute top-0 bottom-0 left-0 w-16 md:w-[80px] z-50 hidden md:block text-[#F4F7FA] pointer-events-none">
                    ...
                    >
                        ...
                        <path 
                            d="M0 0 L0 100 L80 100 C 30 75, 90 25, 60 0 Z" 
                            stroke="url(#edgeGlow)" 
                            strokeWidth="2" 
                ...
                {/* Konten Teks */}
                <div 
                    className="relative z-20 transition-transform duration-700 ease-out pl-12" 
