...
export default function ForgotPassword({ status }) {
    ...
    return (
        <div 
            ...
            className="relative flex flex-col md:flex-row h-screen font-body bg-[#F4F7FA] overflow-hidden"
            onMouseMove={handleMouseMove}
        >
            <Head title="Lupa Password - Pustaka Digital" />
            ...
            <style>
                {`
                    ...
                    /* Menyembunyikan scrollbar form (Mobile) */
            ...
            {/* Responsif: Teks putih di laptop (karena background kiri gelap), teks abu di HP (background terang) */}
            <Link 
                href="/" 
            ...
            {/* ======================================================== */}
            {/* BAGIAN KIRI: VISUAL & ANIMASI PARALLAX (Seperti Login) */}
            {/* ======================================================== */}
            <div className="relative hidden md:flex md:w-1/2 h-full bg-animated-gradient items-center justify-center overflow-hidden z-10">
                ...
                {/* S-CURVE DIVIDER (Mengarah ke Kiri) */}
            ...
            {/* ======================================================== */}
            {/* BAGIAN KANAN: RUANG FORM LUPA PASSWORD */}
            {/* ======================================================== */}
            <div className="w-full md:w-1/2 h-full flex flex-col items-center justify-center p-6 md:p-8 z-20 bg-[#F4F7FA] overflow-y-auto hide-scroll">
                
                <div className="w-full max-w-md bg-white/80 backdrop-blur-md rounded-[20px] shadow-[0_8px_30px_rgba(0,0,0,0.06)] border border-white/50 p-6 sm:p-10 transition-all duration-300 hover:shadow-[0_15px_40px_rgba(0,0,0,0.08)] animate-slide-up-fade relative z-10 mt-12 md:mt-0">
                    <div className="mb-6 text-center sm:text-left">
                        <h2 className="text-3xl font-heading font-bold text-[#10375C]">Lupa Password</h2>
                    </div>

                    <div className="mb-6 p-4 rounded-xl bg-[#10375C]/5 border border-[#10375C]/10 text-sm text-gray-600 font-light leading-relaxed">
                        Lupa password Anda? Tidak masalah. Masukkan alamat email Anda dan kami akan mengirimkan tautan untuk mengatur ulang password baru.
                    </div>

                    {status && (
                        <div className="mb-6 text-sm font-medium text-green-600 bg-green-50 p-3 rounded-xl border border-green-100">
                            {status}
                        </div>
                    )}
                    ...
                    <form onSubmit={submit} className="space-y-6">
                        ...
                        <div className="pt-2 animate-btn-delay">
                            <PrimaryButton 
                                ...
                                disabled={processing}
                            >
                                <span className="relative z-10">Kirim Tautan Reset</span>
                    ...
                    <div className="mt-8 text-center animate-btn-delay">
                        <Link
                            href={route('login')}
                            className="inline-flex items-center text-sm font-medium text-gray-500 hover:text-[#10375C] transition-colors duration-200 group"
                        >
